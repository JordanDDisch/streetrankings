...
export const RootProvider = withProvider<
  HTMLDivElement,
  Assign<Assign<HTMLStyledProps<'div'>, Dialog.RootProviderBaseProps>, DialogVariantProps>
>(Dialog.RootProvider, 'content')

export type RootProps = ComponentProps<typeof Root>
export const Root = withProvider<
  HTMLDivElement,
  Assign<Assign<HTMLStyledProps<'div'>, Dialog.RootBaseProps>, DialogVariantProps>
>(Dialog.Root, 'content')
